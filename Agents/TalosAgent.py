...
class Talos():
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.WaistX_DOF, self.WaistY_DOF, self.WaistZ_DOF = 2, 1, 0
        self.RShX_DOF,   self.RShY_DOF,   self.RShZ_DOF   = 28, 29, 30
        self.REB_DOF                                      = 31
        self.LShX_DOF,   self.LShY_DOF,   self.LShZ_DOF   = 11, 12, 13
        self.LEB_DOF                                      = 14

        self.RHipX_DOF,  self.RHipY_DOF,   self.RHipZ_DOF   = 54, 53, 52
        self.RKneeX_DOF, self.RAnkleX_DOF, self.RAnkleY_DOF = 55, 56, 57
        self.LHipX_DOF,  self.LHipY_DOF,   self.LHipZ_DOF   = 47, 46, 45
        self.LKneeX_DOF, self.LAnkleX_DOF, self.LAnkleY_DOF = 48, 49, 50
        ...
        self.RShX = math.radians(-30)
        self.RShY = math.radians(-5)
        self.RShZ = math.radians(0)
        self.REB = math.radians(-30)

        self.LShX = math.radians(30)
        self.LShY = math.radians(5)
        self.LShZ = math.radians(0)
        self.LEB = math.radians(-30)
